...
const TopNavbar = () => {
  ...
  return (
    <div className="">
        ...
        <div className=" bg-base_color p-p_6px  hidden lg:flex ">
          {" "}
            ...
            <div className="flex flex-row items-start lg:items-center lg:space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <a
                  ...
                  className="text-xs lg:text-text_title text-white hover:text-white"
                >
              ...
              <div className="flex items-center space-x-2">
                ...
                <a
                  ...
                  className="text-white hover:text-white text-xs lg:text-text_title"
                >
                  +880 1511 004 002
                </a>
                <a
