      ...
      <nav className="bg-white z-10 w-full shadow-lg">
        <div className="w-full  xl:w-[1300px] mx-auto   lg:py-p_8px  flex justify-between items-center  ">
          ...
          <div className="space-x-6 hidden lg:flex  ">
            <Link
              to="/"
              className={`relative pb-[4px] font-bold text-black hover:border-t-2 border-t-2 border-white hover:border-color_NavbarOld_hover hover:bg-gray-200 px-2 ${
                selected === "/"
