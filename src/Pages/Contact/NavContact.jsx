      ...
      >
        ...
        <div className="py-32 flex items-center justify-center flex-col text-white relative">
          <h1 className="text-5xl mb-4 font-bold">
            Contact <span className="text-[#E41F3F]"> Total Student Care</span>
          </h1>
          <p className="text-lg">
            Do you want to study in the UK? Do you need help with university
        ...
        <div>
            ...
            <div className="flex-1 flex items-center">
              <div>
                <p className="text-text_large font-normal text-justify">
                  Important- It is highly recommended to you that you talk to us
                  about your tours and travels. We have our experienced tour
                  experts who will guide you with all the valid information that
                  you need to know about your tours. You can ask questions and
                  can have a clear idea about your tour. Accommodations, foods,
                  visas, pricing of packages, all information should be
                  discussed beforehand to avoid any misunderstanding in the
                  future. You can reach us through email. Send us a mail and we
                  will get back to you right away. Or you can call us directly
                  at the given phone number and talk to us. The best way is to
                  come to visit us, have a cup of tea and talk to our expert
                  guides in person and book your package right away!
                </p>
          ...
          <div className="mt-5 grid grid-cols-1  lg:grid-cols-3 w-full xl:w-[1300px] mx-auto  gap-5 mb-m_24px">
            ...
            <div className=" text-center shadow p-5 rounded border border-gray-300">
              ...
              <h5 className="mt-2 text-gray-700"> contact@travelsmentor.com</h5>
            </div>
