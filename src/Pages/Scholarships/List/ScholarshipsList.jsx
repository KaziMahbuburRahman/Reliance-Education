...
const universities = [
  ...
  },
  {
    ...
    amount: "Up to £6500",
    courses: "Undergraduate and postgraduate (Taught)",
    eligibleCountry: "All nationals. Scholarships amount will vary country wise",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        ...
        style={{ backgroundImage: `url('https://www.totalstudentcare.com/ux/tsc/img/scholarships2.jpeg')` }}
      >
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-center relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-white text-lg mt-2">
              Undergraduate & Postgraduate scholarships for international students from UK Universities
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-semibold">
              <span className="inline-block mr-2">Find a range of international scholarships</span>
            </h2>
          ...
          <p className="text-gray-600 text-center">
            Find a range of international scholarships, bursaries and tuition fees discounts offered by our partner
        ...
        >
          {paginatedUniversities.map((uni) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-semibold mb-3 text-gray-800">{uni.name}</h3>
                <div className="space-y-2 mb-4">
                  ...
                  <p>
                    <span className="font-medium text-gray-700">Course for scholarship: </span>
                    {uni.courses}
                  </p>
                  <p>
                    <span className="font-medium text-gray-700">Eligible country: </span>
                    {uni.eligibleCountry}
                  </p>
                </div>
          ...
          <nav className="flex items-center space-x-1">
            ...
            {[...Array(totalPages)].map((_, i) => (
              <button
                ...
                className={`px-4 py-2 rounded-md ${currentPage === i + 1 ? "bg-blue-600 text-white" : "text-gray-700 hover:bg-gray-200"}`}
              >
                {i + 1}
              </button>
            ))}
